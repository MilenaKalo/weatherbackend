...
public class WeatherService {
    /*
    @Autowired
    private WeatherOfCity weatherOfCity;
    private OkHttpClient client;
    private Response response;
    private String cityName;
    private String unit;
    private String APIkey = "8f72af7c99ac2ff422253044302e41c7";
    ...
    public JSONObject getWeather(){
        ...
        okhttp3.Request request = new Request.Builder()
            .url("http://api.openweathermap.org/data/2.5/weather?q="+weatherOfCity.getName()+"&units="+weatherOfCity.getUnit()+"&appid="+APIkey)
            .build();
